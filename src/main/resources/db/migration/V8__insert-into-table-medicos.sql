DELETE FROM `priorymed_api`.`medicos`;


INSERT INTO `priorymed_api`.`medicos` (`id`, `nombre`, `email`, `documento`, `especialidad`, `calle`, `distrito`, `complemento`, `numero`, `ciudad`, `telefono`, `activo`)
